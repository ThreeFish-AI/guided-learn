...
- **验收门**：`validate --quality showcase` 0 错 0 警（9 项 artifact checks）→ `deliver`（冻结
  快照、SHA-256 回执）→ `visual-check`（真实浏览器 1440×900/1600×1000/1920×1080
  containment 全过；面向大型桌面显示器时再增加 2048×1320）。**validate 单图 ≤10 轮**是硬纪律；
  两轮聚焦修复无改善即停下如实报告。
...
| 全部 | 默认桌面视口（1440×900、1600×1000、1920×1080）须通过 containment；面向大型桌面显示器时再检查 2048×1320 | visual-check overflowY |
